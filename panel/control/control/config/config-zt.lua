...
mysql.storyConfig      = "..\\zentaostory\\config\\my.php"
mysql.taskConfig       = "..\\zentaotask\\config\\my.php"
mysql.testConfig       = "..\\zentaotest\\config\\my.php"
mysql.proConfig        = "..\\zentaopro\\config\\my.php"
