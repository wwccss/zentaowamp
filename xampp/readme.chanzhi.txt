...
1. 如何启动蝉知：
  ...
  1.2 进入xampp目录，双击start.bat脚本，启动蝉知控制面板程序。
  1.3 通过蝉知控制面板程序即可启动蝉知运行环境，并访问。

  如果无法通过控制面板启动蝉知，进入xampp\service目录，双击运行install.bat，来安装并启动蝉知的服务。
...
详细的介绍，请访问：http://www.chanzhi.biz
...
1. How to start chanzhi:
  ...
  1.2 Enter the xampp directory and double click the start.bat to start the control panel of chanzhi.
  1.3 Click the 'Start' button to start chanzhi.
